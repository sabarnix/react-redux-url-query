...
function replaceUrlQuery(newQuery, location) {
  var shouldCompare = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  ...
  (0, _configureUrlQuery2.default)({ skipStoreSync: true });
...
function replaceInUrlQuery(queryParam, encodedValue, location) {
  var shouldCompare = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
